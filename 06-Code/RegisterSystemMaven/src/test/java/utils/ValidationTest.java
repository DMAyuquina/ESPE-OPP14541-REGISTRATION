...
public class ValidationTest {
    ...
    public void testValidationOfInt_ValidInt() {
        ...
        int expResult = 5;
        int result = Validation.validationOfInt(number, scanner);
    ...
    public void testValidationOfFloat_ValidFloat() {
        ...
        float result = Validation.validationOfFloat(3.14f, scanner);
    ...
    public void testValidationOfFloat_InvalidFloat() {
        Scanner scanner = new Scanner("abc");
        float result = Validation.validationOfFloat(0.0f, scanner);
    ...
    public void testValidationOfFloat_PositiveFloat() {
        ...
        float result = Validation.validationOfFloat(123.456f, scanner);
    ...
    public void testValidationOfFloat_MaxFloat() {
        ...
        float result = Validation.validationOfFloat(Float.MAX_VALUE, scanner);
    ...
    public void testValidationOfFloat_MinFloat() {
        ...
        float result = Validation.validationOfFloat(Float.MIN_VALUE, scanner);
    ...
    public void testValidationOfCharacter_OnlyLetters() {
        ...
        boolean result = Validation.validationOfCharacter(phrase);
        assertTrue(result);
    }
    ...
    public void testValidationEmail_ValidEmail() {
        ...
        boolean result = Validation.validationEmail(email);
        assertTrue(result);
    }
    ...
    public void testValidationDni_ContainsLetters() {
        ...
        boolean result = Validation.validationDni(10, dni);
        assertFalse(result);
    }
    ...
    public void testValidationPhoneNumber_ValidPhoneNumber() {
        ...
        boolean result = Validation.validationPhoneNumber(phoneNumber);
        assertTrue(result);
    }
    ...
    public void testValidationGrade_ValidGrade() {
        String grade = "85";
        boolean result = Validation.validationGrade(grade);
        assertTrue(result);
    }

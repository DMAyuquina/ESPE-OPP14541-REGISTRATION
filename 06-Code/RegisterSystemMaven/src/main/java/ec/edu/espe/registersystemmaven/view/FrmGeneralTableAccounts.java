 ...
 */
public class FrmGeneralTableAccounts extends javax.swing.JFrame {
     ...
     */
    public FrmGeneralTableAccounts() {
        initComponents();
        String ids[] = {"CEDULA", "NOMBRES", "APELLIDOS", "USUARIO", "PASSWORD"};
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CUENTAS DE PROFESORES");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String collectionTutors = "TutorsAccounts";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmGeneralTableAccounts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmGeneralTableAccounts().setVisible(true);
            }
        });
    }

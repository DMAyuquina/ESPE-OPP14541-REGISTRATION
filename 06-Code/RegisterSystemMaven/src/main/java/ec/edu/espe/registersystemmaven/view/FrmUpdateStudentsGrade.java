...
public class FrmUpdateStudentsGrade extends javax.swing.JFrame {
    ...
    public FrmUpdateStudentsGrade() {
        initComponents();
        String ids[] = {"CEDULA", "NOMBRES", "APELLIDOS", "NOTA UNIDAD 1", "NOTA UNIDA 2", "SUPLETORIO"};
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (career.isEmpty()) {
            ...
            for (Document std : students) {
                mt.addRow(new Object[]{std.get("id"), std.get("names"), std.get("lastNames"), std.get("gradeUnitOne"), std.get("gradeUnitTwo"), std.get("lastChance")});
            }
        }
